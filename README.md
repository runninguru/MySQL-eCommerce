...
<li> Also, i'm not trained in law by any means, so if this  database this somehow doesn't meet USA federal/state laws/regulations on computer security, privacy, finance (such as the Sarbanes-Oxley Act), or any other federal, state, or local regulation or law, I am not responsible for your misuse of this code.</li>
